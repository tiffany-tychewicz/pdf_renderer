      ...
      <div v-for="student in students">
        ...
        <div class="resume" style="text-align: center">
          ...
          <div v-for="experience in student.experiences">
            ...
            <div>
              <strong>{{ experience.company_name }}</strong> {{ experience.start_date }} - {{ experience.end_date }}
            </div>
            <div>
              {{ experience.details }}
            </div>
...
export default {
  ...
  methods: {
    ...
    renderPDF: function() {
      ...
      doc.text(`Social: ${this.student.twitter_handle} ${this.student.linkedin_url} ${this.student.personal_url}`, 10, 30);
      ...
      experiences.forEach(function(experience) {
        doc.text(`${experience.job_title}, ${experience.company_name}, ${experience.start_date}- ${experience.end_date}`, x, y);
        y += 10;
      });
      ...
      education.forEach(function(school) {
        doc.text(`${school.university_name}, ${school.start_date} - ${school.end_date}, degree in ${school.degree}`, x, y);
        y += 10;
      });
      y += 10;
